    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('teacher-dashboard') }}">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('tcourse-list') }}">Courses</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('routine-session') }}">Class Routine</a>
            </li>
            <li class="nav-item active">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('tlogout') }}">Logout</a>
            </li>
        </ul>
    </div>
</nav>
